...
//   // date is September 15, 2023 7:00 PM
//   const targetDate = new Date("2023-09-15T20:00:00").getTime();

//   // update the countdown every second (interval)
...
//     // checking if the target date has passed
//     if (timeRemaining < 0) {
//       clearInterval(countdownInterval); // stopts the coutdown
